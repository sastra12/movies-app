  ...
  <section class="mt-12">
    <footer class="w-full bg-primary">
      <div class="py-6 max-w-max mx-auto">
        <h1 class="text-center text-white text-base">&copy; 2023 Sastra R</h1>
        <div class="flex gap-6 sm:gap-8 justify-center my-4">
          <a href="https://github.com/sastra12">
          ...
          <a href="https://www.linkedin.com/in/sastra-rianto/">
        ...
        <span class="text-white"
          ...
          <a href="https://pinia.vuejs.org/" class="text-secondary">Pinia</a> &
